 ...
 */
public abstract class Electro implements Serializable {
    ...
    public String writeToFile() {
        String formatedName = name.replace(' ','_');
        return String.format("%s %s %b %d %d ",this.getClass(),formatedName, inSocket, electroRadiation, capacity);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.getName().equals(electro.getName()) && this.getSocket() == electro.getSocket()
                && this.getCapacity() == electro.getCapacity() && this.getRadiation() == electro.getRadiation()) {
            return true;
        }
